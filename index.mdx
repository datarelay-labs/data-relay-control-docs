...
Data Relay Control is the public product name for the software currently implemented in [`datarelay-labs/gdc-platform`](https://github.com/datarelay-labs/gdc-platform). It is an **Enterprise Data Control Gateway**: it collects data, transforms it, applies optional protection and policy controls, and delivers it to one or more destinations.
...
Start with the [Quick Start](/getting-started/quickstart), then review [Architecture](/getting-started/architecture) and [Known Limitations](/reference/limitations).
